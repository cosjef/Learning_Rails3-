class StudentsController < ApplicationController
  ...
  # list the courses a student is in
  def courses
  ...
  # no real query string used here, just convenient notation for parameters
  def course_add
    ...
    if not @student.enrolled_in?(@course)
      ...
      flash[:notice] = 'Student was successfully entrolled'
    else
  ...
  def course_remove
    ...
    course_ids.each do |course_id|
      ...
      logger.info "Removing studen from course #{course.id}"
      @student.courses.delte(course)
